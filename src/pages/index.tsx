        ...
        <main className="container mx-auto px-4 py-12 sm:py-14 bg-white">
          <div className="mb-3.5">
            <h2 className="text-3xl sm:text-4xl font-semibold text-center sm:mb-7 gradient-text">
              ...
              <div className="relative z-10 mt-6 flex items-center justify-between bg-green-100 border border-green-200 rounded-xl px-4 py-2 shadow-md text-green-900">
                {/* Badge de oferta */}
                <div className="hidden md:flex items-center gap-2">
                  ...
                  <span className="text-green-800 font-semibold uppercase tracking-wider text-sm">
                    ¡Oferta Mayorista!
                  </span>
                </div>

                {/* Mensaje de promoción */}
                <p className="text-center text-sm sm:text-base font-medium flex-1 text-green-900">
                  Llevando{" "}
                  <span className="font-bold text-green-800">5 unidades</span> de la misma pieza tenés un{" "}
                  <span className="font-bold text-green-700">30% de descuento</span>
                </p>
              </div>
          </div>
